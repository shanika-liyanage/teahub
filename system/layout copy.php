          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?= SYS_URL ?>suppliers/index.php" class="nav-link">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?= SYS_URL ?>customers/view.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>view customer</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?= SYS_URL ?>products/view.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>view product</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?= SYS_URL ?>orders/index.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>view order</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?= SYS_URL ?>users/index.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>view User</p>
                  </a>
                </li>
