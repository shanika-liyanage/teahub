...
<head>
    ...
    <link href="<?= WEB_URL ?>assets/lib/animate/animate.min.css" rel="stylesheet">
    <link href="<?= WEB_URL ?>assets/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="fw-medium" href="#">Imbulgahagoda</a>, All Right Reserved.
                </div>
    ...
    <script src="<?= WEB_URL ?>assets/lib/wow/wow.min.js"></script>
    <script src="<?= WEB_URL ?>assets/lib/easing/easing.min.js"></script>
    <script src="<?= WEB_URL ?>assets/lib/waypoints/waypoints.min.js"></script>
    <script src="<?= WEB_URL ?>assets/lib/owlcarousel/owl.carousel.min.js"></script>
